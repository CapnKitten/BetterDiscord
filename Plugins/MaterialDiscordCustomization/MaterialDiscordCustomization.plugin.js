  ...
  changelog: [
    {
      ...
      items: ["Added the unit type to the slider legends."],
    },
    {
      type: "added",
...
const { DOM, Webpack, UI, React, Patcher, Utils, Data } = new BdApi(
  config.info.name,
);
const { Filters } = Webpack;

const Slider = Webpack.getModule(
  (m) => Filters.byKeys("stickToMarkers", "initialValue")(m?.defaultProps),
  { searchExports: true },
);
const Button = Webpack.getModule(Filters.byKeys("Link", "Sizes"), {
  searchExports: true,
});
const Flex = Webpack.getModule(Filters.byKeys("Child", "Justify", "Align"), {
  searchExports: true,
});
...
module.exports = class MaterialDiscordCustomization {
  ...
  getSettingsPanel() {
    const ACCENT_HEX_DEFAULT = this.hslToHex(
      this.defaultSettings.accent.h,
      this.defaultSettings.accent.s,
      this.defaultSettings.accent.l,
    );
    const ACCENT_HEX_LOADED = this.hslToHex(
      this.settings.accent.h,
      this.settings.accent.s,
      this.settings.accent.l,
    );
    ...
    const element = UI.buildSettingsPanel({
      ...
      settings: [
        ...
        },
        {
          ...
          inline: true,
          onChange: (e) => {
            ((this.settings["accent"].textColor = e), this.saveAndRefresh());
          },
        },
        {
          type: "category",
          ...
          settings: [
            ...
            },
            {
              ...
              children: React.createElement(Slider, {
                ...
                stickToMarkers: true,
                onMarkerRender: (v) =>
                  v % 250 === 0 || v === 100 ? (v / 1000).toFixed(1) : "",
          ...
          settings: [
            {
              ...
              children: React.createElement(Slider, {
                ...
                onValueChange: (e) => {
                  ((this.settings["button"].height = e), this.saveAndRefresh());
                },
              }),
            },
            {
              ...
              children: React.createElement(Slider, {
                ...
                onValueChange: (e) => {
                  ((this.settings["button"].radius = e), this.saveAndRefresh());
                },
              }),
            },
            {
      ...
      React.createElement(
        Button,
        {
          ...
          onClick: () =>
            confirm(
              "Reset Settings?",
              "This will reset your Material Discord customizations back to their default settings.",
              {
                onConfirm: () => {
