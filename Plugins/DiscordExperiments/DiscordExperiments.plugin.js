...
module.exports = (() => {
  const config = {
    info: {
      ...
      github:
        "https://github.com/CapnKitten/BetterDiscord/blob/master/Plugins/DiscordExperiments/DiscordExperiments.plugin.js",
      github_raw:
        "https://raw.githubusercontent.com/CapnKitten/BetterDiscord/master/Plugins/DiscordExperiments/DiscordExperiments.plugin.js",
    },
  };
    ...
    : (([Plugin, Api]) => {
        const plugin = (Plugin, Api) => {
          return class DiscordExperiments extends Plugin {
            onStart() {
              let c = webpackChunkdiscord_app.push([
                [Symbol()],
                {},
                (r) => r.c,
              ]);
              ...
              let m = Object.values(
                u._dispatcher._actionHandlers._dependencyGraph.nodes,
              );

              u.getCurrentUser().flags |= 1;
              m.find(
                (x) => x.name === "DeveloperExperimentStore",
            ...
            stop() {
              BdApi.showConfirmationModal(
                "Refresh Required",
                "In order to disable Discord Experiments, you must refresh your client.",
                {
                  confirmText: "Refresh",
                  cancelText: "Cancel",
