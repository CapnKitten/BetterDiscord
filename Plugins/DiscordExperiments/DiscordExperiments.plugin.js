	...
	return !global.ZeresPluginLibrary ? class {
		...
		const plugin = (Plugin, Api) => {
			return class DiscordExperiments extends Plugin {
				onStart() {
					let c = webpackChunkdiscord_app.push([[Symbol()],{},r=>r.c]); webpackChunkdiscord_app.pop();
					let u = Object.values(c).find(x=>x?.exports?.default?.__proto__?.getUsers && x?.exports?.default?.getCurrentUser)?.exports?.default;
