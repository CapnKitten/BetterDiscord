...
.nowPlayingColumn-2sl4cE {
  ...
  .nowPlayingColumn-2sl4cE .container-lRFx4q {
    background-color: var(--main-color); }
    .nowPlayingColumn-2sl4cE .container-lRFx4q .scroller-2ZPeAD {
      margin-left: 0;
      border-left: none; }
...
.mainContent-u_9PKf .icon-1DeIlz path {
  ...
  .mainContent-u_9PKf .icon-1DeIlz path[d="M11.383 3.07904C11.009 2.92504 10.579 3.01004 10.293 3.29604L6 8.00204H3C2.45 8.00204 2 8.45304 2 9.00204V15.002C2 15.552 2.45 16.002 3 16.002H6L10.293 20.71C10.579 20.996 11.009 21.082 11.383 20.927C11.757 20.772 12 20.407 12 20.002V4.00204C12 3.59904 11.757 3.23204 11.383 3.07904ZM14 5.00195V7.00195C16.757 7.00195 19 9.24595 19 12.002C19 14.759 16.757 17.002 14 17.002V19.002C17.86 19.002 21 15.863 21 12.002C21 8.14295 17.86 5.00195 14 5.00195ZM14 9.00195C15.654 9.00195 17 10.349 17 12.002C17 13.657 15.654 15.002 14 15.002V13.002C14.551 13.002 15 12.553 15 12.002C15 11.451 14.551 11.002 14 11.002V9.00195Z"], .mainContent-u_9PKf .icon-1DeIlz path[d="M15 12C15 12.0007 15 12.0013 15 12.002C15 12.553 14.551 13.002 14 13.002V15.002C15.654 15.002 17 13.657 17 12.002C17 12.0013 17 12.0007 17 12H15ZM19 12C19 12.0007 19 12.0013 19 12.002C19 14.759 16.757 17.002 14 17.002V19.002C17.86 19.002 21 15.863 21 12.002C21 12.0013 21 12.0007 21 12H19ZM10.293 3.29604C10.579 3.01004 11.009 2.92504 11.383 3.07904C11.757 3.23204 12 3.59904 12 4.00204V20.002C12 20.407 11.757 20.772 11.383 20.927C11.009 21.082 10.579 20.996 10.293 20.71L6 16.002H3C2.45 16.002 2 15.552 2 15.002V9.00204C2 8.45304 2.45 8.00204 3 8.00204H6L10.293 3.29604Z"] {
    d: path("M3 9v6h4l5 5V4L7 9H3zm7-.17v6.34L7.83 13H5v-2h2.83L10 8.83zM16.5 12c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77 0-4.28-2.99-7.86-7-8.77z"); }
  .mainContent-u_9PKf .icon-1DeIlz path[d="M3.9 8.26H2V15.2941H3.9V8.26Z"], .mainContent-u_9PKf .icon-1DeIlz path[d="M4.85 8.26429L15.84 5.84426V10.5599C15.84 11.6202 16.6996 12.4799 17.76 12.4799H21V19.0586H19.1V17.9302L12.7065 16.524L10.36 19.6233C10.1776 19.8633 9.89545 19.9998 9.6 19.9998C9.524 19.9998 9.4461 19.9904 9.3701 19.9725L5.5701 19.0313C5.1464 18.925 4.85 18.5495 4.85 18.1175V8.26429ZM9.2181 17.9942L6.75 17.3824V15.2111L10.6706 16.0751L9.2181 17.9942Z"] {
  ...
  .mainContent-u_9PKf .icon-1DeIlz path[d="M21.025 5V4C21.025 2.88 20.05 2 19 2C17.95 2 17 2.88 17 4V5C16.4477 5 16 5.44772 16 6V9C16 9.55228 16.4477 10 17 10H19H21C21.5523 10 22 9.55228 22 9V5.975C22 5.43652 21.5635 5 21.025 5ZM20 5H18V4C18 3.42857 18.4667 3 19 3C19.5333 3 20 3.42857 20 4V5Z"], .mainContent-u_9PKf .icon-1DeIlz path[d="M22.025 2V3C22.5635 3 23 3.43652 23 3.975V7C23 7.55228 22.5523 8 22 8H18C17.4477 8 17 7.55228 17 7V4C17 3.44772 17.4477 3 18 3V2C18 0.88 18.95 0 20 0C21.05 0 22.025 0.88 22.025 2ZM19 3H21V2C21 1.42857 20.5333 1 20 1C19.4667 1 19 1.42857 19 2V3Z"] {
    transform: translateX(-7px) scale(1.35);
    fill: var(--interactive-normal);
    opacity: 1; }
  .mainContent-u_9PKf .icon-1DeIlz path[d="M3.9 8.25981H2V15.2939H3.9V8.25981Z"] {
...
.reactions-12N0jA {
  ...
  .reactions-12N0jA .reaction-1hd86g {
    ...
    border-radius: 12px;
    border: none; }
    .reactions-12N0jA .reaction-1hd86g:hover {
      background-color: var(--menu-item-select); }
...
.contentRegion-3nDuYy div[role="tabpanel"] {
  width: 100%;
  height: 100%; }
...
.contentRegion-3nDuYy div[role="tabpanel"] + .toolsContainer-1edPuj {
  position: absolute;
  width: 60px;
  height: 60px;
  right: 0; }
  .customColumn-Rb6toI + .toolsContainer-1edPuj .tools-3-3s-N,
  .contentRegion-3nDuYy div[role="tabpanel"] + .toolsContainer-1edPuj .tools-3-3s-N {
    position: absolute;
    width: 36px;
    right: -8px; }
...
#bd-settings-sidebar .ui-tab-bar-item {
  ...
  #bd-settings-sidebar .ui-tab-bar-item[aria-controls="Overlay-tab"]:before {
    ...
    -webkit-mask-repeat: no-repeat;
    mask-repeat: no-repeat; }
  .side-8zPYf6 .item-PXvHYJ.bd-settings-tab:before,
  #bd-settings-sidebar .ui-tab-bar-item.bd-settings-tab:before {
    background-color: var(--text-normal);
    ...
    -webkit-mask-repeat: no-repeat;
    mask-repeat: no-repeat; }
  .side-8zPYf6 .item-PXvHYJ.bd-emotes-tab:before,
  #bd-settings-sidebar .ui-tab-bar-item.bd-emotes-tab:before {
    background-color: var(--text-normal);
    ...
    -webkit-mask-repeat: no-repeat;
    mask-repeat: no-repeat; }
  .side-8zPYf6 .item-PXvHYJ.bd-customcss-tab:before,
  #bd-settings-sidebar .ui-tab-bar-item.bd-customcss-tab:before {
    background-color: var(--text-normal);
    ...
    -webkit-mask-repeat: no-repeat;
    mask-repeat: no-repeat; }
  .side-8zPYf6 .item-PXvHYJ.bd-plugins-tab:before, .side-8zPYf6 .item-PXvHYJ[aria-controls="pluginrepo-tab"]:before,
  #bd-settings-sidebar .ui-tab-bar-item.bd-plugins-tab:before,
  #bd-settings-sidebar .ui-tab-bar-item[aria-controls="pluginrepo-tab"]:before {
    ...
    -webkit-mask-repeat: no-repeat;
    mask-repeat: no-repeat; }
  .side-8zPYf6 .item-PXvHYJ.bd-themes-tab:before, .side-8zPYf6 .item-PXvHYJ[aria-controls="themerepo-tab"]:before,
  #bd-settings-sidebar .ui-tab-bar-item.bd-themes-tab:before,
...
.description-3_Ncsb + .button-38aScr.sizeMedium-1AC_Sl {
  max-width: 180px; }
...
.container-VSDcQc {
  ...
  .container-VSDcQc .autocompleteShadow-iiGWFU {
    display: none; }
  .container-VSDcQc .autocompleteArrow-Zxoy9H {
    background-color: var(--popout-color) !important; }
  .container-VSDcQc .header-2bNvm4 {
    padding: 0 16px;
    background-color: transparent !important;
    border-bottom: 1px solid var(--popout-header-border); }
    .container-VSDcQc .header-2bNvm4 .input-1ppKdn {
      width: calc(100% - 32px); }
  .container-VSDcQc .sectionTag-pXyto9 {
    background-color: transparent !important; }
  .container-VSDcQc .section-sfKw6q {
    padding: 0 16px;
    text-transform: none;
    font-size: 14px; }
  .container-VSDcQc .row-rrHHJU {
    padding: 0; }
    .container-VSDcQc .row-rrHHJU .rowInner-1vvRiF {
      padding: 12px 16px;
      border-radius: 0;
      transition: var(--default-time) var(--default-animation) background-color; }
    .container-VSDcQc .row-rrHHJU.selected-1pIgLL .rowInner-1vvRiF {
      background-color: var(--menu-item-hover);
      color: var(--menu-item-text-color); }
...
.allactivities-right .button-38aScr,
.allactivities-left .button-38aScr {
  padding: 0 !important; }
...
.container-3auIfb {
  ...
  .container-3auIfb[style*="background-color: rgb(59"] {
    background-color: rgba(var(--accent-rgb), 0.3) !important; }
  .container-3auIfb[style*="background-color: rgb(59"] .slider-TkfMQL {
    background-color: var(--accent-color) !important; }
  .container-3auIfb[style*="background-color: rgb(60"] {
    background-color: rgba(var(--accent-rgb), 0.3) !important; }
  .container-3auIfb[style*="background-color: rgb(60"] .slider-TkfMQL {
    background-color: var(--accent-color) !important; }
  .container-3auIfb[style*="background-color: rgb(61"] {
    background-color: rgba(var(--accent-rgb), 0.3) !important; }
  .container-3auIfb[style*="background-color: rgb(61"] .slider-TkfMQL {
    background-color: var(--accent-color) !important; }
  .container-3auIfb[style*="background-color: rgb(62"] {
    background-color: rgba(var(--accent-rgb), 0.3) !important; }
  .container-3auIfb[style*="background-color: rgb(62"] .slider-TkfMQL {
    background-color: var(--accent-color) !important; }
  .container-3auIfb[style*="background-color: rgb(63"] {
    background-color: rgba(var(--accent-rgb), 0.3) !important; }
  .container-3auIfb[style*="background-color: rgb(63"] .slider-TkfMQL {
    background-color: var(--accent-color) !important; }
  .container-3auIfb[style*="background-color: rgb(64"] {
    background-color: rgba(var(--accent-rgb), 0.3) !important; }
  .container-3auIfb[style*="background-color: rgb(64"] .slider-TkfMQL {
    background-color: var(--accent-color) !important; }
  .container-3auIfb[style*="background-color: rgb(65"] {
    background-color: rgba(var(--accent-rgb), 0.3) !important; }
  .container-3auIfb[style*="background-color: rgb(65"] .slider-TkfMQL {
    background-color: var(--accent-color) !important; }
  .container-3auIfb[style*="background-color: rgb(66"] {
    background-color: rgba(var(--accent-rgb), 0.3) !important; }
  .container-3auIfb[style*="background-color: rgb(66"] .slider-TkfMQL {
    background-color: var(--accent-color) !important; }
...
.bd-switch {
  ...
  .bd-switch input:checked + .bd-switch-body {
    --switch-color: rgba(var(--accent-rgb),0.3); }
